    ...
    <div className="min-h-screen pb-nav" style={{ background: '#050505' }}>
      ...
      <div className="px-4 pt-14 pb-4">
        <div className="flex items-center gap-2.5 mb-1">
          ...
          <div className="h-5 w-28 rounded-full" style={{ background: '#222222' }} />
        </div>
        <div className="h-3 w-36 rounded-full mt-1" style={{ background: '#222222' }} />
      </div>

      {/* Next Reward skeleton */}
      <div className="px-4 mb-4">
        <div className="rounded-3xl p-5" style={{ background: '#1D1D1D', border: '1px solid rgba(237, 116, 47,0.25)' }}>
          ...
          <div className="h-3 w-24 rounded-full mb-2" style={{ background: '#222222' }} />
      ...
      <div className="px-4 mb-6 grid grid-cols-3 gap-2">
        {[1, 2, 3].map(i => (
          <div key={i} className="rounded-2xl h-20" style={{ background: '#171717', border: '1px solid rgba(255,255,255,0.13)' }} />
        ))}
      </div>

      {/* Section skeleton */}
      <div className="px-4 mb-6">
        <div className="h-2.5 w-40 rounded-full mb-2" style={{ background: '#222222' }} />
        <div className="h-3 w-56 rounded-full mb-3" style={{ background: '#222222' }} />
        <div className="rounded-2xl overflow-hidden" style={{ background: '#222222', border: '1px solid rgba(255,255,255,0.15)' }}>
          {[1, 2, 3].map((i, idx, arr) => (
