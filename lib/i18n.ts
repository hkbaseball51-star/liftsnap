...
const translations = {
  en: {
    ...
    rewards: {
      ...
      milestone: {
        calendar:          'Track your training history',
        weekly_summary:    'See your weekly training overview',
        basic_chart:       'Visualize your progress',
        exercise_progress: 'Deep dive per exercise',
        weekly_comparison: 'Compare training weeks',
        advanced_stats:    'Detailed analytics preview',
        yearly_report:     'Your annual training summary',
      },
      theme: {
        default: 'Clean monochrome style',
        orange:  'LIFTSNAP orange accent',
        purple:  'Electric purple accent',
        black:   'Pure black minimal style',
      },
    },
    record: {
  ...
  ja: {
    ...
    rewards: {
      trainMore: '記録を続けるほど、分析機能やテーマが解放されます。',
